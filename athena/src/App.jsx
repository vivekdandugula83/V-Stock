...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 grain">
          ...
          <div className="mt-8">
            ...
            {completedCount > 0 && (
              <>
                ...
                {view === 'dashboard' && (
                  <Dashboard aggregate={agg} onSectorClick={scrollToSector} onTickerClick={(t) => setDeepDiveTicker(t)} />
                )}
      ...
      {/* Floating V-Advisor chat */}
      <AdvisorChat
        apiKey={apiKey}
        picks={agg.topConviction.length > 0 ? agg.allPicks : []}
        regime={regime}
        watchlist={watchlist}
        onTickerClick={(t) => setDeepDiveTicker(t)}
      />
